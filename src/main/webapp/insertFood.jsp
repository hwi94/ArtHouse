...
<form action="adminInsert.do" method="post" enctype="multipart/form-data">
    <table border="1" id="table_css">
    	<tr>
    		...
    		<td><input type="text" name="code" id="productCode" width="500"></td>
    	</tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="category" id="productCategory"></td>
        </tr>
        <tr>
            <td id="p_price" height="30">가격</td>
            <td><input type="text" name="price" id="productPrice"></td>
        </tr>
        <tr>
