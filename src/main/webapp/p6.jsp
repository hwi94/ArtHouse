...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<div class="page-body">
	<h1>카라멜&치즈 믹스팝콘(L) 상세페이지</h1>
	<hr>
	<form action="cartInsert.do" method="post">
	<img src="/artHouse/resources/img/food/pop6.jpg">
	<p class="food_name">더블치즈팝콘(L)</p>
	<p class="food_price">6,000</p>
	<input type="hidden" name="code" value="pop6">  <!-- 상품명 -->
	<input type="hidden" name="price" value="6000">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="카라멜&치즈 믹스팝콘(L)">  <!-- 상품명 -->
