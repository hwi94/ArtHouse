...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<div class="page-body">
	<h1>스위트랜치 팝콘(M) 상세페이지</h1>
	<hr>
	<form action="cartInsert.do" method="post">
	<img src="/artHouse/resources/img/food/pop13.jpg">
	<p class="food_name">스위트랜치 팝콘(M)</p>
	<p class="food_price">6,500</p>
	<input type="hidden" name="code" value="pop13">  <!-- 상품명 -->
	<input type="hidden" name="price" value="6500">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="스위트랜치 팝콘(M)">  <!-- 상품명 -->
