...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<img src="/artHouse/resources/img/food/pop9.jpg">
	<p class="food_name">고소팝콘(M)</p>
	<p class="food_price">4,500</p>
	<input type="hidden" name="code" value="pop9">  <!-- 상품명 -->
	<input type="hidden" name="price" value="4500">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="고소팝콘(M)">  <!-- 상품명 -->
