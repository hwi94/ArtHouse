...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<div class="page-body">
	<h1>리얼 치즈팝콘(M) 상세페이지</h1>
	<hr>
	<form action="cartInsert.do" method="post">
	<img src="/artHouse/resources/img/food/pop12.jpg">
	<p class="food_name">리얼 치즈팝콘(M)</p>
	<p class="food_price">6,000</p>
	<input type="hidden" name="code" value="pop12">  <!-- 상품명 -->
	<input type="hidden" name="price" value="6000">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="리얼 치즈팝콘(M)">  <!-- 상품명 -->
