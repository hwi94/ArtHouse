...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<img src="/artHouse/resources/img/food/pop2.jpg">
	<p class="food_name">달콤팝콘(L)</p>
	<p class="food_price">5,500</p>
	<input type="hidden" name="code" value="pop2">  <!-- 상품명 -->
	<input type="hidden" name="price" value="5500">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="달콤팝콘(L)">  <!-- 상품명 -->
