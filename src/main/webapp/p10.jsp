...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<img src="/artHouse/resources/img/food/pop10.jpg">
	<p class="food_name">달콤팝콘(M)</p>
	<p class="food_price">5,000</p>
	<input type="hidden" name="code" value="pop10">  <!-- 상품명 -->
	<input type="hidden" name="price" value="5000">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="달콤팝콘(M)">  <!-- 상품명 -->
