...
<body>
 <jsp:include page="top.jsp"></jsp:include> 
	...
	<div class="page-body">
	<h1>바질어니언팝콘(M) 상세페이지</h1>
	<hr>
	<form action="cartInsert.do" method="post">
	<img src="/artHouse/resources/img/food/pop7.jpg">
	<p class="food_name">바질어니언팝콘(M)</p>
	<p class="food_price">5,500</p>
	<input type="hidden" name="code" value="pop7">  <!-- 상품명 -->
	<input type="hidden" name="price" value="5500">  <!-- 상품가격 -->
	<input type="hidden" name="name" value="바질어니언팝콘(M)">  <!-- 상품명 -->
